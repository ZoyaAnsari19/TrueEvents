...
export default function AboutSection() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            >
              TrueEvents is your complete event management solution, designed to transform complex logistics into seamless experiences. Whether you're hosting a corporate conference or a dream wedding, we've got you covered.
            </motion.p>
          </motion.div>
  ...
  <Link href="#category" className="inline-block w-full sm:w-auto">
    <motion.button
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.95 }}
      className="group relative inline-flex w-full sm:w-auto justify-center items-center space-x-3 
                 px-6 sm:px-8 md:px-10 
                 py-4 sm:py-4 md:py-5 
                 bg-gradient-to-r from-blue-600 to-cyan-600 
                 text-white font-bold text-sm sm:text-base md:text-lg 
                 rounded-full shadow-xl hover:shadow-blue-500/40 
    ...
    >
      ...
      <ArrowDown className="relative z-10 w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
    </motion.button>
  </Link>
