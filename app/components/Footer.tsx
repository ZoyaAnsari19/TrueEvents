  ...
  return (
    <footer className="relative bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">
                  TrueEvents newsletter
                </h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  Receive expert insights, product news, customer stories and
          ...
          {/* Mobile: 2-column layout for sections */}
          <div className="sm:hidden">
            <div className="grid grid-cols-2 gap-8">
              {/* Left Column: PRODUCTS + RESOURCES */}
              ...
              {/* Right Column: SOLUTIONS + COMPANY */}
              <div className="space-y-8">
                {/* SOLUTIONS */}
                <div className="space-y-4">
                  <motion.div
          ...
          {/* PRODUCTS (Hidden on mobile - shown in custom mobile layout above) */}
          ...
          {/* SOLUTIONS (Hidden on mobile - shown in custom mobile layout above) */}
          <div className="hidden sm:block space-y-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* RESOURCES (Hidden on mobile - shown in custom mobile layout above) */}
          <div className="hidden sm:block space-y-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* COMPANY (Hidden on mobile - shown in custom mobile layout above) */}
          <div className="hidden sm:block space-y-4">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
